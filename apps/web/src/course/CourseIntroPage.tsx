...
export default function CourseIntroPage() {
  ...
  if (
    ...
    course.error.code === "COURSE_PILOT_ACCESS_REQUIRED"
  ) {
    return (
      <CourseChrome backHref="/courses" backLabel="返回学习中心">
        <CoursePageState
          title="课程正在授权试学"
          detail="当前账号尚未进入试学名单。授权开放后，可以从本页直接开始学习。"
          action={
            <a className="course-button course-button-primary" href="/">
              返回首页
            </a>
          }
        />
        ...
        <section className="course-intro-hero">
          <div className="course-intro-copy">
            <div className="course-card-badges">
              <span className="course-badge course-badge-blue">试学版</span>
