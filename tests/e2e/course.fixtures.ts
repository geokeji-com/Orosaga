...
import courseCatalog from "../../apps/api/dist/course/course-catalog.js";
const { courseChapters, courseLessons, courseStepFor } = courseCatalog;

const enrollmentId = "70000000-0000-4000-8000-000000000001";
const courseVersion = "1.0.0";
